...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		var artistName:String = PlayState.SONG.artist;
		if (PlayState.SONG.artist == null) artistName = 'Unknown';

		levelInfo.text = PlayState.SONG.song + '\nArtist: ' + artistName;
		if(Difficulty.list.length < 2) levelInfo.text += '\nDifficulty: ' + Difficulty.getString().toUpperCase();
		levelInfo.text += '\n' + PlayState.deathCounter + ' Blue Balls';
