...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('version', Main.psychVersion.trim());
		...
		set('scoreZoom', Settings.data.scoreZoom);
		...
		Lua_helper.add_callback(lua, "startDialogue", function(dialogueFile:String, ?music:String = null) {
			...
			path = Paths.getPath('data/$songPath/${dialogueFile}_${Settings.data.language}.json', TEXT);
			#if MODS_ALLOWED
	...
	public function initLuaShader(name:String)
	{
		...
		var foldersToCheck:Array<String> = [Paths.getSharedPath('data/shaders/')];
		#if MODS_ALLOWED
		foldersToCheck.push(Paths.mods('data/shaders/'));
		if(Mods.currentModDirectory != null && Mods.currentModDirectory.length > 0)
			foldersToCheck.insert(0, Paths.mods(Mods.currentModDirectory + '/data/shaders/'));
