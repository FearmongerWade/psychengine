...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create()
	{
		...
		stageDropDown.list = loadFileList('stages/', 'data/stages/stageList.txt');
		onChartLoaded();
	...
	function reloadNotesDropdowns()
	{
		...
		{
			eventsList = [];
			var eventFiles:Array<String> = loadFileList('data/custom_events/', ['.txt']);
			for (file in eventFiles)
			{
				var desc:String = Paths.getTextFromFile('data/custom_events/$file.txt');
